...
| `/volunteer/` | Volunteer | Post-migration Next.js enhancement | Header and footer Get Involved links; volunteer CTAs on Contact, Board & Staff, and Hope In Action | Volunteer conversion | Route-specific page using the accepted global shell | Volunteer hero, mission intro, opportunity cards, three-step expectation flow, Typeform CTA | External volunteer interest form; no local form or invented testimonial content | Not applicable; added after the Elementor migration | Typeform volunteer intake; generated illustrative route-specific imagery | Medium | **COMPLETE** |
